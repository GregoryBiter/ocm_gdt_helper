...
/**
 * Класс DB - Laravel-подобный Query Builder для OpenCart
 */
class DB
{
    /** @var object */
    ...
    /**
     * Алиас для получения одной строки (совместимость)
     *
     * @return array|null
     */
    public function row()
    ...
    /**
     * Алиас для получения всех строк (совместимость)
     *
     * @return array
     */
    ...
    {
        $new = new static($this->registry);
        $new->table = DB_PREFIX . $table;
        return $new;
    }
